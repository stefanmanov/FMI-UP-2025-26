# Информатика - УП 25/26 - практикум-консултация - седмица 4

## Функции. Упражняване на цикли и битови операции.
...
- Извлечете проверката дали дадено число е просто в отделна функция.
Модифицирайте прогамата, така че да изведе всички прости числа, по-малки или равни на `n`.

### Задача 3

Сиси е странно момиче и още от ранна детска възраст обича специалните числа. Първото ѝ любимо нещо било да намира най-големия общ делител на 2 числа. Вашата задача е да зарадвате Сиси, като напишете програма, която приема 2 цели числа и намира техния най-голям общ делител.
...
записано с водещи нули в 16-ична и в 4-тична бройна система.
...
но не е палиндром в 4-тична (когато ги групираме по два).
Функцията трябва да върне 3 за параметри (n, 0, 2) и 15 за параметри (n, 0, 4).

- n = 1 (10) = 0000 0000 0000 0000 0000 0000 0000 0001 (2) не е палиндром нито в 16-ична, нито в 4-тична бройна система
...
Напишете програма, която по въведено нечетно естествено число `n` рисува успоредник с височина n,
заедно с две от височините му, по следния шаблон:
