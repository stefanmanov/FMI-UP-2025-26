# Информатика - УП 25/26 - практикум-консултация - седмица 1

## Типове данни. Променливи и константи. Вход и изход. Аритметични и други оператори. Изрази.
...
Напишете програма, която чете на стандартния вход три цели числа - дължините на страните на триъгълник - и извежда на екрана периметъра на този тригълник. Решете същата задача, но за числа с плаваща запетая.

### Задача 3

Отново прочетете три страни на триъгълник (дробни числа). Намерете и изведете на стандартния изход неговото лице.

### Задача 4

Прочетете две цели числа от стандартния вход. Разменете стойностите им:

- Като използвате помощна променлива;
- Чрез аритметични операции.

### Задача 5

Стоян е студент във ФМИ. Той има 4 изпита през зимния семестър. Помогнете му да пресметна средния си успех за семестъра, като прочетете 4 оценки, които са:
...
Помислете къде можете да използвате константи.
