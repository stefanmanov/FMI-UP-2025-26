...
- Напишете програма, която чете на стандартния вход три цели числа - дължините на страните на триъгълник - и извежда на екрана периметъра на този тригълник.
- Решете същата задача, но за числа с плаваща запетая.
