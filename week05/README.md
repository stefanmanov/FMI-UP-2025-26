# Информатика - УП 25/26 - практикум-консултация - седмица 5
...
### Задача 1 (помощна за следващите)

Напишете функции за въвеждане на масив:
- от цели числа;
- от реални числа.

### Задача 2

Напишете програма, която приема масив с $N <= 1000$ реални числа и:
- изчислява и извежда средноаритметичното им;
- извежда най-близкото до него от въведените.
...
Ще наричаме редицата от числа $N_1, N_2, ... N_n$ зигзагообразно нарастваща, ако всеки неин елемент
с четен индекс е по-голям от предходните два, а всеки с нечетен е по-малък от предходния, т.е. ако
...
Модифицирайте решението си на задача 6, така че да приема масив с $N <= 1000$ естествени числа, не по-големи от 10 000,
